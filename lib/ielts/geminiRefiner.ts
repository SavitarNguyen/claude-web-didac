...
**CRITICAL - ERROR-FREE SENTENCE REQUIREMENT FOR BAND 8:**
- **80-90% of sentences must be completely error-free** (NOT EVEN ONE TINY MISTAKE)
- "Error-free" means absolutely NO grammatical errors, regardless of how sophisticated the sentence is
- Even complex sentences with advanced vocabulary don't count as "error-free" if they have ANY mistake
...
**CRITICAL - ERROR-FREE SENTENCE REQUIREMENT FOR BAND 7:**
- **40-50% of sentences must be completely error-free** (NOT EVEN ONE TINY MISTAKE)
- "Error-free" means absolutely NO grammatical errors, even tiny ones
- A sophisticated sentence with one small error (missing article, wrong punctuation) does NOT count as error-free
- Must also use complex sentences (not just simple sentences) for range
...
**ERROR FREQUENCY FOR BAND 6:**
- **Errors occur occasionally** throughout the essay
- Less than 40% of sentences are error-free
- Complex sentences often contain errors while simple sentences may be correct
...
**ERROR FREQUENCY FOR BAND 5:**
- **Errors occur frequently and repeatedly** throughout the essay
- Same types of errors appear multiple times
- Very few error-free sentences (less than 20-30%)
...
## GRAMMATICAL ACCURACY: BAND 6 VS BAND 7 COMPARISON

**Topic: Family (Body Paragraph 2)**
...
**Grammatical Range:**
(1) Complex sentence | (2) Simple sentence | (3) Complex sentence | (4) Complex sentence | (5) Complex sentence

**Grammatical Accuracy:**
(1) ❌ Wrong verb form ("should divided"), run-on sentence (missing punctuation), sentence sprawl (too many clauses)
(2) ✅ Error-free sentence
(3) ❌ Missing punctuation (comma after "Although"), redundant conjunction ("so")
(4) ❌ Missing punctuation (", however,"), missing article ("have an old-minded attitude")
(5) ❌ Redundant conjunction ("so"), wrong verb form ("men thinks"), sentence sprawl (too many clauses)

**Error Count: 4 out of 5 sentences contain errors = Only 20% error-free → Band 6**
...
(2) ✅ Error-free sentence
(3) ✅ Error-free sentence
(4) ❌ Wrong article ("houseworks" is uncountable, remove "the")
(5) ❌ Missing article ("a conservative mindset"), missing comma before "since"

**Error Count: 2 out of 5 sentences contain errors = 60% error-free → Band 7**

**Key Observations:**
- **Band 7** demonstrates flexibility with complex sentences while maintaining higher accuracy
- **Band 7** uses punctuation correctly and avoids run-on sentences
- **Band 7** errors are minor (article, punctuation) vs. Band 6 errors (verb forms, sentence sprawl, run-ons)
- **Band 6** shows frequent and repeated errors; **Band 7** shows only occasional small errors
