...
CREATE POLICY "Enable insert for authenticated users only" ON "public"."flashcards" FOR INSERT TO "authenticated" WITH CHECK (true);
...
CREATE POLICY "Enable update for authenticated users only" ON "public"."flashcards" FOR UPDATE TO "authenticated" USING (true);
